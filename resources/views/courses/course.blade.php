...
@section('content')
    <div class="flex justify-start gap-3">
        ...
        <a href="{{ route('lessonsListForAddToCourse', $course) }}"
            ...
            @foreach ($course->publications as $publication)
                @if ($publication->test == null)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg w-full border border-gray-100">
                        <!-- Шапка карточки с иконкой лекции -->
                        <div class="bg-[#1aa2c0] px-6 py-4 flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <h2 class="text-xl font-bold text-white">{{ $publication->lesson->name }}</h2>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
                                <!-- Пустой div для выравнивания (оставлен для сохранения структуры) -->
                                <div></div>
                            ...
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('getLesson', $publication->lesson) }}"
                                    class="px-5 py-2.5 bg-[#1aa2c0] text-white rounded-lg hover:bg-[#158a9d] transition-colors flex items-center">
                                    Изучить
                                    <svg xmlns="http://www.w3.org/2000/svg" class="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg w-full border border-gray-100">
                    ...
                    <div class="p-6">
                        <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
                            ...
                            <!-- Дата создания (перемещена вправо) -->
                            <div class="flex items-center text-sm text-gray-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
