    ...
    >
      ...
      >
        ...
        <div class="w-full grow space-y-3 p-4">
          ...
          <a
            href="{{ route('getMyLessons') }}"
            class="{{ request()->routeIs('getMyLessons') ? 'current' : ''}} flex items-center gap-3 rounded-lg px-4 py-2 font-semibold text-slate-600 hover:bg-white hover:shadow-xs hover:shadow-slate-300/50 active:bg-white/75 active:text-slate-800 active:shadow-slate-300/10"
          >
